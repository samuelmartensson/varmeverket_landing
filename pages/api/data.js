...
const scrollingText = "BOOK A SPACE!";

const showCase1 = {
  headerThin: "POWERED.BY.",
  headerThick: "VÄRMEVERKET.",
...
const footerData = {
  contact: "CONTACT",
  largeHeaderThin: "KEEP.IN.",
  largeHeaderBold: "TOUCH.",
  conversation: "Start a conversation",
  email: "info@varmeverket.com",
  officeHeader: "Our office",
  officeText: "Stockholm",
  officeRows: ["Stockholm", "Bredängsvägen 203", "12734 Skärholmen"],
  policyHeader: "Our policy",
